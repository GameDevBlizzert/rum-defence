...
public static class Level1Data
{
    ...
    private static List<Wave> Waves => new()
    {
        ...
        CreateWave(minSpawnTime: 10f, maxSpawnTime: 20f, (NormalShip,  1, [(Regular,   10,  25)],                            2f), (NormalShip, 1, [(Regular, 10, 50)], 2f)),
        CreateWave(minSpawnTime:  7f, maxSpawnTime: 13f, (NormalShip,  2, [(Regular,   4,  50)],                           1.0f), (NormalShip, 1, [(Bomber, 2, 50)], 3f)),
        CreateWave(minSpawnTime:  0f, maxSpawnTime:  3f, (NormalShip,  2, [(Regular,   7,  50)],                           0.6f), (NormalShip, 1, [(Regular, 2, 50)], 3f)),
        CreateWave(minSpawnTime:  6f, maxSpawnTime: 11f, (NormalShip,  6, [(Regular,   4,  50)],                             1f), (BossShip, 1, [(Boss, 1, 500)], 0.1f), (NormalShip, 1, [(Bomber, 3, 80)], 2f)),
    };
